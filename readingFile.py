def reading(n):
    ...
    transactionDf['Numb_transactions'] = transactionDf['Numb_transactions'].astype(int)



    #try adding the amount of rows
    # transactionDf = transactionDf.append([transactionDf] * transactionDf.Numb_transactions, ignore_index=True)
